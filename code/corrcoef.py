...
file1 = os.path.join('../data/proc_corrs','l3264f211b600m00507m0507m628a-coul-v5','Hy_m0.650.txt')
file2 = os.path.join('../data/proc_corrs','l3264f211b600m00507m0507m628a-coul-v5','t32_Hy_m0.650.txt')
