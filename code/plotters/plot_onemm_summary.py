...
import sys
sys.path.append('..')
from commonweal import plym_onemm_gev, onemm_mass, onemm_exp
...
plt.errorbar(y=1.7, x=plym_onemm_gev[0].mean, xerr=plym_onemm_gev[0].sdev ,yerr=0, fmt='h',mfc='none',color='r',label=r'This work (PRELIMINARY)',lw=1)
...
#plt.text(4.3, 1.35, 'PRELIMINARY', fontsize=6, bbox={'facecolor': 'pink', 'alpha': 0.7, 'pad': 4})
