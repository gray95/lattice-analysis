...
##charged-down
corr_danA  = util.load_data("../docs/rho_vcphys_bothcharges_m0.003328.gpl", nt, nconfig_dan, "charged-down"  )
...
plt.errorbar(tt_dan, corr_dan_mean , corr_dan_err  ,  fmt= 'bo' , label="up charged" )
plt.errorbar(tt_danA, corr_danA_mean , corr_danA_err  ,  fmt= 'ro' , label="down charged" )
